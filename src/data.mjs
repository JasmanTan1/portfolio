...
export const HERO = {
  ...
  seeking:
    'Open to backend or full-stack engineering roles in Singapore. Full-time, on-site or hybrid.',
};
...
export const PROJECTS = [
  {
    ...
    problem:
      'Kubrix was built in 2019 by a nine-person DigiPen Singapore team on a custom C++ engine, and won Game of the Year at the DigiPen Game Awards that year. I was one of its programmers. It then became unrunnable — a Windows build, a 27 GB SVN repository and an engine nobody has compiled since.',
    built:
  ...
  },
  {
    ...
    outcome:
      'Plays 5–12 seats on a living-room Wi-Fi network, and is now served from the home server through Cloudflare Tunnel. One server process hosts one game at a time — it is an evening with friends, not a public multiplayer service.',
...
export const EDUCATION = [
  {
    ...
    period: '2015 – 2020',
    note: 'Game of the Year, DigiPen Game Awards 2019 — Kubrix, as a gameplay programmer (custom ImGui editor).',
  },
  {
